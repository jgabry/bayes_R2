...
\title{\bf R-squared for Bayesian model fits\footnote{
...
replace $V_{i=1}^n e_i^s$ in the denominator of \eqref{rsq3} by its expectation
...
will be more complicated than the function presented here in order to
